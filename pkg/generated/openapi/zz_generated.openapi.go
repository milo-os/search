...
func schema_pkg_apis_search_v1alpha1_ResourceIndexPolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"go.miloapis.net/search/pkg/apis/search/v1alpha1.ResourceIndexPolicySpec", "go.miloapis.net/search/pkg/apis/search/v1alpha1.ResourceIndexPolicyStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_search_v1alpha1_ResourceIndexPolicyList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"go.miloapis.net/search/pkg/apis/search/v1alpha1.ResourceIndexPolicy", v1.ListMeta{}.OpenAPIModelName()},
	}
}
